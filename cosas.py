...
class Persona:
    ...
    def dormir(self):
        print("Zzzzzz que calors...zzzzzz")
...
class Alumno(Persona):
    ...
    def dormir(self):
        print(super().nombre, "esta durmiendo el alumno")
...
class Profesor(Persona):
    descripcion = "Una persona que dice que enseña pero se la pasa leyendo artículos de investigacion"
...
class AyudanteProfesor(Alumno, Profesor):
    ...
    def __str__(self):
        return Alumno.__str__(self) + str(self.numero_trabajador) + self.area + f"Horas de trabajo {self.__horas}"
